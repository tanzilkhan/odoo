...
class export_register_line(osv.Model):
    ...
    def onchange_pi_no(self,cr,uid,ids,pi_no,context=None):
        ...
        if pi_no is not False:
            ...
            if id:
                ...
                pi_unit_price=pi_brw.invoice_line.price_unit
                pi_price_subtotatal=pi_brw.invoice_line.price_subtotal
                pi_quantity=pi_brw.invoice_line.quantity
            else:
                pi_customer=False
                pi_unit_price=False
            ...
            result['value'] = {'buyer_name': pi_customer,
    ...
    _columns = {
        ...
        'buyer_name': fields.many2one('res.partner', 'Buyer Name', required=True),
