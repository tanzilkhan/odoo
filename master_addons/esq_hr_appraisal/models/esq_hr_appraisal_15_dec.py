...
class hr_appraisal_form(osv.osv):
    ...
    def create(self, cr, uid, values, context=None):
        ...
        if total_weight == 100:
            ...
            raise osv.except_osv(_('Error!!'),_('Summation of the weights of the criterion in the form is not equal to 100.'))
...
class hr_appraisal(osv.osv):
    ...
    def write(self, cr, uid, ids, value, context=None):
        ...
        if 'appraisal_goal' in value:
            ...
            if total_weight != 100:
                raise osv.except_osv(_('Attention!'),_('Total weight must be equal to 100.'))
